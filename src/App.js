                ...
                <div className="space-y-2">
                  {selectedTarget.tools.map((tool, index) => (
                    <div key={index} className="bg-gray-100 p-3 rounded">
                      ...
                      <div className="text-sm text-gray-600">Details: {tool.details || 'N/A'}</div>
                    </div>
                  ))}
                </div>
              </div>
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="flex mb-4">
        ...
        <button
          className={`px-4 py-2 mr-2 flex items-center ${activeTab === 'running-operations' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        {activeTab === 'new-operation' && <NewOperationTabs />}
        {activeTab === 'running-operations' && <CurrentlyRunningOperations />}
